      ...
      <div class="heroSection__content container q-mb-xl">
        <div class="row full-width q-mb-xl">
          <div class="col-12 col-md-6 vertical-middle self-center">
            <h2 class="text-h3 text-white text-weight-medium fredoka">Bem Vindo ao Meu App</h2>
          ...
          <div class="col-0 col-md-6">
            <img
              :style="($q.screen.md || $q.screen.lg || $q.screen.xl) ? 'width: 300px; max-width: fit-content;' : 'width: 100%; max-width: 100%;'"
